      ...
      return (
        <div>
          <h1 className="text-primary">
            <span className="text-dark">Welcome To</span> Smart Poll App
          </h1>
          <hr />
          <p className="lead">
            You can create as many as poll you want. Click the new button to
            create a new poll. To check details of a poll please select from the
            left sidebar. By selecting a poll you can check details, participate
